...
docker run --tty --interactive --rm \
  ...
  --env ENV_GITHUB_REPOSITORY='archlinux-battery-discharging' \
  ...
  --env ENV_PACKAGE_DEPENDENCIES='|  bash|  coreutils|  grep|  alsa-utils|  util-linux|' \
  --env ENV_PACKAGE_DESCRIPTION='Command-line tool that makes a sound whenever the computer battery is not connected to electrical power.' \
  ...
  --env ENV_PACKAGE_NAME='battery-discharging' \
